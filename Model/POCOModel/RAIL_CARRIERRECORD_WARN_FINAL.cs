...
namespace Model
{
	public partial class RAIL_CARRIERRECORD_WARN_FINAL
	{
		public RAIL_CARRIERRECORD_WARN_FINAL ToPOCO(bool isPOCO = true){
			return new RAIL_CARRIERRECORD_WARN_FINAL(){
