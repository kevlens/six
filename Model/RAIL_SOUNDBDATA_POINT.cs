...
namespace Model
{
    ...
    {
        public RAIL_SOUNDBDATA_POINT()
        {
            this.RAIL_SECTION_LINE = new HashSet<RAIL_SECTION_LINE>();
            this.RAIL_SOUNDDEVICE_WARN = new HashSet<RAIL_SOUNDDEVICE_WARN>();
        }
        ...
        public virtual RAIL_SOUNDBDATA_SECTION RAIL_SOUNDBDATA_SECTION { get; set; }
        public virtual ICollection<RAIL_SOUNDDEVICE_WARN> RAIL_SOUNDDEVICE_WARN { get; set; }
