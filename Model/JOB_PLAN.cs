...
namespace Model
{
    ...
    public partial class JOB_PLAN
    {
        public JOB_PLAN()
        {
            this.JOB_PLAN_LINE = new HashSet<JOB_PLAN_LINE>();
            this.JOB_PLAN_CONTROL = new HashSet<JOB_PLAN_CONTROL>();
        }
        ...
        public Nullable<System.DateTime> PLANTIME_DATE { get; set; }
        ...
        public virtual ICollection<JOB_PLAN_LINE> JOB_PLAN_LINE { get; set; }
        public virtual ICollection<JOB_PLAN_CONTROL> JOB_PLAN_CONTROL { get; set; }
    }
}
